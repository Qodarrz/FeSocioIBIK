...
export default function KomunitasPage() {
  ...
  return (
    <div className="min-h-screen mt-30 bg-gray-50 dark:bg-black transition-colors duration-200">
      <main className="max-w-9xl mx-10 px-4 py-6">
        <div className="flex gap-3">
          <div className="flex-1 max-w-9xl">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 mb-6 shadow-sm border border-gray-200 dark:border-gray-800">
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-800">
                    ...
                    <button className="px-5 py-2 bg-primary hover:bg-secondary text-white font-medium rounded-full transition-all duration-200 hover:scale-105 active:scale-95">
                      Posting
                    </button>
                  </div>
                </div>
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-800">
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    ...
                    <button className="px-3 py-1 text-xs font-medium bg-black dark:bg-white text-white dark:text-black rounded-full hover:opacity-90 transition-opacity">
                      Ikuti
                    </button>
                  </div>
                ))}
