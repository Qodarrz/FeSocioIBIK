...
export default function ResetPassPage() {
	...
	return (
	  <div className=" bg-background w-full flex items-center justify-center text-text dark:bg-black pt-10 dark:text-textDark h-screen">
		<div className="bg-white dark:bg-gray-900 dark:border-0 border-1 text-center p-10 mt-15 border-gray-300 w-[90%] md:w-[450px] h-auto rounded-2xl">
		  ...
		  <form onSubmit={handleSubmit} className="flex flex-col gap-5 my-8">
			<input
			  ...
			  className="w-full py-4 px-3 border bg-white border-gray-200 dark:bg-gray-800 dark:border-0  rounded-lg"
			  required // Tambahkan validasi form
			/>
			<button type="submit" className="btn bg-primary btn-border-reveal z-10 transition-all ease-in-out cursor-pointer text-white rounded-2xl py-3">
			  Kirim Reset Link
			</button>
		  </form>
		  <p>
