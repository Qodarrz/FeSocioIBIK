    ...
    return (
        <div className="mt-10" >
            <div className="text-center mx-5 md:mx-10 mb-20">
                <h1 className="font-bold text-3xl md:text-6xl ">Mari 
                    <ShinyText
                    text="Peduli"
                    speed={3}
                    delay={0}
                    ...
                    />
                    Sejak Dini</h1>
                <p className="mt-2 text-gray-500">Terhadap sekitar kita yang lebih membutuhkan dan memerlukan bantuan kita.</p>
