...
export default function Footer() {
  ...
  return (
    <footer className="rounded-2xl mx-5 md:mx-10 relative pt-20 z-999999 overflow-hidden">
        ...
        <div className="w-full px-2 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
              Platform AI & komunitas untuk membantu masyarakat melaporkan
              masalah kota dan berbagi solusi demi lingkungan yang lebih baik.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              ...
              <li>Tracking Laporan</li>
              <li>Analisis AI</li>
              <li>Forum Komunitas</li>
              <li>Edukasi Publik</li>
            </ul>
          </div>
