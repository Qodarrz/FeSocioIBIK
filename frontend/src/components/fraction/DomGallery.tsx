...
const DEFAULT_IMAGES: ImageItem[] = [
  ...
  {
    src: "/images/bencana/b2.jpg",
    alt: "Modern sculpture",
  },
  {
    src: "/images/bencana/b3.jpg",
    alt: "Digital artwork",
  },
  {
    src: "/images/bencana/b4.jpg",
    alt: "Contemporary art",
  },
  {
    src: "/images/bencana/b5.webp",
    alt: "Geometric pattern",
  },
  {
    src: "/images/bencana/b6.jpg",
    alt: "Textured surface",
  },
  {
    src: "/images/bencana/b7.jpg",
...
export default function DomeGallery({
  ...
  const startAutoRotateY = useCallback(() => {
    ...
    const loop = (time: number) => {
      ...
      const SPEED = 8; // derajat per detik (atur feel di sini)
      const deltaDeg = (SPEED * delta) / 1000;

      const nextY = wrapAngleSigned(
        rotationRef.current.y + deltaDeg
      );
    ...
    if (wantsResize) {
      const onFirstEnd = (ev: TransitionEvent) => {
        ...
        requestAnimationFrame(() => {
          ...
          overlay.style.width = tempHeight;
          overlay.style.height = tempHeight;
        });
        const cleanupSecond = () => {
          ...
          <div
            ...
            style={{
              backgroundImage: !isDark
                ? ``
                : `radial-gradient(rgba(235, 235, 235, 0) 65%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`,
            }}
          />
          ...
          <div
            ...
            style={{
              background: !isDark
                ...
                : `linear-gradient(to bottom, transparent, var(--overlay-blur-color, ${overlayBlurColor}))`,
            }}
          />
          <div
